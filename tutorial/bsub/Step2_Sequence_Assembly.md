...
### Next steps
To get to the next steps, follow the [Orthology Assessment](https://github.com/scrameri/CaptureAl/blob/master/tutorial/bsub/Step3_Orthology_Assessment.md) tutorial.
