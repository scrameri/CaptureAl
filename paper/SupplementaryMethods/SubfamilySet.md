...
```
The sequence names in `consFabaceae_4c_1005.fasta` were used to extract 3273 corresponding probe sequences (`Fabaceae1005_3273probes_1005reg.fasta`, see [script](ProbeSets/extract_probes.R)).
